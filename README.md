...
Antes de comenzar, es necesario obtener una clave de API de TMDb. Se puede obtener una clave de API registrandose en el sitio web de TMDb. Una vez obtenida la clave de API, se reemplaza `'API_KEY'` en el código con la clave de API.
